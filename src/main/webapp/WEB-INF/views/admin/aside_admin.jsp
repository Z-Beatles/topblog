    ...
    <section class="sidebar">
        ...
        <form action="#" method="get" class="sidebar-form">
            <div class="input-group">
                ...
                <span class="input-group-btn"><button type="submit" name="search" id="search-btn" class="btn btn-flat"><i
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview ${param.pageCatalog=='article'?'active':''}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="${param.pageMenu=='article_new'?'active':''}"><a href="${ctx}/article/new"><i class="fa fa-pencil-square-o"></i>
                        写文章</a></li>
                    <li class="${param.pageMenu=='article_category'?'active':''}"><a href="${ctx}/article/category"><i class="fa fa-language"></i>
                        分类目录</a></li>
            ...
            <li class="treeview ${param.pageCatalog=='tools'?'active':''}">
                ...
                <ul class="treeview-menu">
                    <li class="${param.pageMenu=='tools_import'?'active':''}"><a href="${ctx}/tools/import"><i class="fa fa-level-down"></i>数据导入</a>
                    </li>
                    <li class="${param.pageMenu=='tools_export'?'active':''}"><a href="${ctx}/tools/export"><i class="fa fa-level-up"></i>数据导出</a>
                    </li>
                </ul>
            </li>
            <!-- 设置 -->
            <li class="treeview ${param.pageCatalog=='setup'?'active':''}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="${param.pageMenu=='setup_discussion'?'active':''}"><a href="${ctx}/setup/discussion"><i class="fa fa-commenting-o"></i>评论</a>
                    </li>
