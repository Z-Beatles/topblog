	...
	<div class="login-box-body">
		...
		<form action="/login" method="post" id="loginform">
			...
			<div class="form-group has-feedback">
				<input type="text" class="form-control" placeholder="帐号" name="username" value="${sessionScope.userCountNum}">${sessionScope.errormsg}
...
<script>
    $(document).ready(function() {
        console.log("${sessionScope.userCountNum}"+","+"${sessionScope.errormsg}")
        $('.icheck').iCheck({
