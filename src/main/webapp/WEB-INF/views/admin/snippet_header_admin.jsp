...
<script type="text/javascript" src="${ctxPath}/static/plugin/bootstrapvalidator-0.5.3/js/bootstrapValidator.js"></script>
<script type="text/javascript" src="${ctxPath}/static/plugin/adminlte-2.3.7/js/app.min.js"></script>
