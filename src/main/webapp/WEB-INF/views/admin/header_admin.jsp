                    ...
                    <c:when test="${ch.isAdminLogin()}">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <ul class="menu">
                                        <li>
                                            <a href="#">
                                                <div class="pull-left"><img src="${ch.adminAvatar(req)}" class="img-circle" alt="头像"></div>
                        ...
                        <li class="dropdown notifications-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <ul class="menu">
                                        <li><a href="${ctx}/comment"><i class="fa fa-users text-aqua"></i>收到3条新的留言</a></li>
                                    </ul>
                                </li>
                                <li class="footer"><a href="${ctx}/comment">查看全部</a></li>
                            </ul>
                        </li>
                        <!-- 任务列表 -->
                        ...
                        <li class="user user-menu">
                            <a href="#" data-toggle="dropdown">
                                <img src="${ch.adminAvatar(req)}" class="user-image" alt="头像">
                                <span class="hidden-xs">${ch.adminNickname(req)}</span>
                            </a>
                            <ul class="dropdown-menu">
